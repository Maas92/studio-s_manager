...
export const getAllProducts = catchAsync(async (req: UserRequest, res: Response, next: NextFunction) => {
  let queryText = `
    SELECT 
      p.*,
  ...
  const features = new APIFeatures(queryText, queryParams, req.query)
    .filter()
...
export const getProduct = catchAsync(async (req: UserRequest, res: Response, next: NextFunction) => {
...
export const createProduct = catchAsync(async (req: UserRequest, res: Response, next: NextFunction) => {
  const {
...
export const updateProduct = catchAsync(async (req: UserRequest, res: Response, next: NextFunction) => {
  const allowedFields = [
    'name', 'sku', 'category_id', 'brand', 'supplier_id', 'description',
    'unit_of_measure', 'unit_cost', 'retail_price', 'reorder_level', 
    'expiry_tracking', 'is_active'
  ];
...
export const deleteProduct = catchAsync(async (req: UserRequest, res: Response, next: NextFunction) => {
  const result = await pool.query(
